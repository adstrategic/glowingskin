...
const portfolioData = [
    {
        image: portfolio1,
        description: "Elegant bridal hair and makeup, tailored to perfection for your special day",
        imageOrder: "order-1",
        textOrder: "order-2",
    },
    {
        image: portfolio2,
        description: "A peek inside our luxurious salon space, where beauty and relaxation meet",
    ...
    {
        image: portfolio4,
        description: "Classic French manicure with a modern twist of style and grace",
...
const Portfolio = () => {
    return (
        <section className="bg-[url('../images/flower-left.png'),_url('../images/flower-right.png')] bg-no-repeat bg-[position:0px_100%,100%_4%]" id="d2c_portfolio">
            <div className="container">
                ...
                <div className="grid md:grid-cols-2 bg-secondary">
                    {portfolioData.map((item, index) => (
                        <React.Fragment key={index}>
                            ...
                            <div className={`p-10 flex items-end ${item.textOrder}`}>
                                <p className="d2c_portfolio_description">{item.description}</p>
                            </div>
                        </React.Fragment>
                    ))}
                </div>
