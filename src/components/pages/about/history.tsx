        ...
        <div className="grid grid-cols-12 gap-4 md:gap-10 lg:gap-6">
          ...
          <div className="space-y-4 xl:space-y-10 col-start-1 md:col-start-7 lg:col-start-8 col-span-12 md:col-span-6 lg:col-span-5">
            ...
            <p className="text-sm-1 xl:text-lg">
              Founded in 2019 in the heart of Miami Beach, Glowing Skin Beauty
              Bar began as a dream to revolutionize the beauty and wellness
              industry. Our founder, Angie, recognized the need for a space
              where advanced technology meets personalized care.
            </p>
            <p>
              What started as a small clinic has grown into a premier
              destination for luxury aesthetic treatments. We've built our
              reputation on combining cutting-edge technology with the warmth
              and expertise of our certified professionals.
            </p>
            <p>
              Over the years, we've expanded our services to include the latest
              in non-invasive treatments, always maintaining our commitment to
              safety, quality, and exceptional results.
            </p>
          </div>
        </div>
      </div>
